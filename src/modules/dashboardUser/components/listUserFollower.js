...
const ListUserFollowerComponent = ({ listUser }) => {
	return (
		<>
			<h4 className="mb-3">Followers ({listUser?.meta?.total})</h4>
			{isEmpty(listUser.data) ? (
				<EmptyBox text="Empty followers" />
			) : (
...
export default ListUserFollowerComponent;
